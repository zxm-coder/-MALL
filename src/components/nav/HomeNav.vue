<template>
  <div>
    ...
    <div class="nav-body">
      ...
      <div class="nav-side" ref="navSide">
        <ul>
          ...
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            ...
            <span class="nav-side-item">ipad</span> /
            <span class="nav-side-item">数码</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">电脑</span> /
            <span class="nav-side-item">学生</span> /
          ...
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            ...
            <span class="nav-side-item">坐垫</span> /
            <span class="nav-side-item">靠背</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">母婴</span> /
            <span class="nav-side-item">玩具</span> /
            <span class="nav-side-item">奶粉</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">食品</span> /
            <span class="nav-side-item">烟酒</span> /
            <span class="nav-side-item">生鲜</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">礼品</span> /
            <span class="nav-side-item">绿植</span> /
            <span class="nav-side-item">农资</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">医药</span> /
            <span class="nav-side-item">保健</span> /
            <span class="nav-side-item">计生</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">图书</span> /
            <span class="nav-side-item">音像</span> /
            <span class="nav-side-item">电子</span>
          </li>
        </ul>
      </div>
      ...
      <div class="nav-content-right" v-for="(item, index) in marketing.activity" :key="index">
        <router-link to="/goodsDetail">
          <img :src="item.daohangImag3">
        </router-link>
      </div>
      <div class="nav-content-right" v-for="(item, index) in marketing.activity" :key="index">
        <router-link to="/goodsList">
          <img :src="item.daohangImag4">
        </router-link>
      </div>
      <div class="nav-show">
        <div class="nav-show-img" v-for="(item, index) in marketing.activity" :key="index">
          <router-link to="/goodsList">
            <img :src="item.daohangImag1">
          </router-link>
        </div>
        <div class="nav-show-img" v-for="(item, index) in marketing.activity" :key="index">
          <router-link to="/goodsList">
            <img :src="item.daohangImag2">
          </router-link>
        </div>
      </div>
    </div>
